...
git add Database\price_history.parquet Database\futures_price.parquet Database\indicators.parquet Database\sim_history.parquet Database\active_labels.parquet Database\mc_bands.parquet >> %LOG% 2>&1
